...
def currentLine():
	return fileByLines[actualFileIndex].upper()
...
if os.path.isfile(fileName):
	...
	while True:
		...
		if actualState == initalState:
			if createStatement not in actualLine: 
				actualFileIndex = actualFileIndex + 1
				continue
		...
		elif actualState == createState:
			statementStructure = actualLine.split(' ')
			tableName = cleanTableName(statementStructure[-2])
		...
		elif actualState == attributeState:
	...
	print "The file <" + fileName + "> aint valid man!"

# print attributesInTable['ACTIVITY_TYPE']
# print ''
# print attributesInTable['EXERCICE_LOG']
